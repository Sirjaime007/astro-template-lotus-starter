---
title: Overview
description: Learn how the Lotus starter is organized.
sidebar:
  order: 1
---
...
- `src/theme.config.ts` configures navigation, sidebars, search, and footer links.
...
1. Update the project name and links in `src/theme.config.ts`.
